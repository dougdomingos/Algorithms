 ...
 * 
 * In a singly linked list, every node has a reference to the
 * next node in the list, or null if there is none.
 * 
 * All the O(n) operations in this implementation use the recursive
 * approach.
 */
public class SinglyLinkedList<T extends Comparable<T>> implements LinkedList<T> {
     ...
     */
    private void insertLast(SinglyLinkedListNode<T> head, SinglyLinkedListNode<T> target) {
    ...
    /**
     * Recursive method for inserting an element at a given position in the list.
     * 
     * @param head   The first node of the list
     * @param target The element to be inserted
     * @param index  The index where the element will be inserted
     */
    private void insert(SinglyLinkedListNode<T> head, SinglyLinkedListNode<T> target, int index) {
        if (index == 1) {
     ...
     */
    private void remove(SinglyLinkedListNode<T> head, SinglyLinkedListNode<T> target) {
        if (!(head.getNext() == null)) {
     ...
     * @return A boolean value; true if the element is in the list, false otherwise
     */
    private boolean contains(SinglyLinkedListNode<T> head, SinglyLinkedListNode<T> target) {
        if (head == null) {
            return false;
     ...
     */
    private int indexOf(SinglyLinkedListNode<T> head, SinglyLinkedListNode<T> target) {
