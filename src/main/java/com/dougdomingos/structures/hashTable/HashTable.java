...
public interface HashTable<T> {
     ...
     * @throws StructureOverflowException thrown if the table is full
     */
     ...
     * @throws StructureUnderflowException thrown if the table is empty
     */
     ...
     * @return A boolean value; true if the element is in the table, false otherwise
     */
