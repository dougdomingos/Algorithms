 ...
 * recursively sorting them, and then merges the
 * sorted halves to produce a sorted array.
 * Time Complexity: O(n * log n) | Space Complexity: O(n) Stability: Non-stable
 */
public class MergeSort<T extends Comparable<T>> extends AbstractSort<T> {
	 ...
	 *            The targeted array
	 * @param left
	 *            The start index of the left partition
	 * @param middle
	 *            The start index of the right partition
	 * @param right
	 *            The end index of the right partition
	 */
