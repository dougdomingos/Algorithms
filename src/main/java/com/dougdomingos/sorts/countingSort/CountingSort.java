 ...
 * its correct sorted position. It is particularly efficient when sorting a
 * collection of integers or objects with discrete, non-negative keys.
 * 
...
public class CountingSort extends AbstractSort<Integer> {
    ...
    public void sort(Integer[] array, int left, int right) {
        if ((left >= 0) && (right < array.length) && (left < right) && (array != null)) {
     ...
     * 
     * This implementation considers the smallest element of the array as the first
     * element of the sorted array. Thus, the counting array size is given by:
     * biggest - smallest + 1, where the +1 represents the space for zero.
     * 
     * @param array      The array to be sorted
     * @param leftIndex  The low limit of the array
     * @param rightIndex The high limit of the array
     ...
     */
    private int getIndexBiggest(Integer[] array, int leftIndex, int rightIndex) {
     ...
     */
    private int getIndexSmallest(Integer[] array, int leftIndex, int rightIndex) {
