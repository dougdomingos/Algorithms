...
/**
 * An abstract base class for implementing a sorting algorithm. This class
 * provides a default `sort` method (that sorts the entire array) and an
 * abstract `sort` method that sorts a specified interval within the array.
 */
public abstract class AbstractSort<T extends Comparable<T>>
		implements Sorting<T> {
