 ...
 */
public abstract class AbstractBT<T extends Comparable<T>>
	 ...
	 * @param root
	 *            The root of the subtree
	 * @return The node containing the target value, or null if the value is not
	 *         on
	 *         the subtree
	 */
	...
	/**
	 * Recursive method for finding the predecessor of a node through its
	 * parents.
	 *
	 * @param current
	 * @param target
	 ...
	 *            The root of the subtree
	 * @param array
	 *            The array representing the pre-order
	 * @param index
	 *            The current insertion index of the array
	 */
	 ...
	 *            The root of the subtree
	 * @param array
	 *            The array representing the in-order
	 * @param index
	 *            The current insertion index of the array
	 */
	 ...
	 *            The root of the subtree
	 * @param array
	 *            The array representing the post-order
	 * @param index
	 *            The current insertion index of the array
	 */
